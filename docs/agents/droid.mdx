...
<Step title="Authenticate with Factory AI">
  To use Droid in BetterCoding, you must first authenticate:
...
Droid supports several configuration options in BetterCoding:
...
These options can be configured when creating agent configurations in BetterCoding.
