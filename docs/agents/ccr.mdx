...
## Authentication
Authenticate and configure CCR outside of BetterCoding. Follow the instructions on the CCR GitHub repo:
...
## Configure BetterCoding

BetterCoding does not ship a default configuration for CCR. Add configurations to the existing Claude Code agent:
...
### Example: Claude Code agent configuration in BetterCoding

<Frame>
<img src="/images/vk-ccr-agent-config.png" alt="Claude Code agent configuration in BetterCoding" />
</Frame>

## Using CCR in BetterCoding
