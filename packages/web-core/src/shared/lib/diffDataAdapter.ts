...
/**
 * Maps BetterCoding's DiffChangeKind to pierre/diffs ChangeTypes.
 *
 * Mapping:
 * - 'added' → 'new'
 * - 'deleted' → 'deleted'
...
/**
 * Transforms a BetterCoding Diff to pierre/diffs FileDiffMetadata.
 *
 * Uses parseDiffFromFile from @pierre/diffs to generate the diff metadata
 * from old and new file contents.
 *
 * @param diff - The BetterCoding Diff object
